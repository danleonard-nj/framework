...
class Swagger:
    ...
    Quart without additional metadata.  This includes:
    ...
    * Route segments as parameters
    ...
    def configure(self):
        ...
        in the Quart app.  The `werkzeug` `Rule` class in the route mapping is
    ...
    def _bind_schema_endpoint(self, definitions: dict) -> None:
        ...
        # Quart view function that will return the Swagger definition
        def get_schema():
            return definitions
    ...
    def _build_swagger_definitions(self) -> dict:
        ...
        # Get the Quart endpoints to generate the documentation from
    ...
    def _get_swagger_endpoints(self, exclude_routes: List[str] = None) -> List[SwaggerEndpoint]:
        ...
        # Fetch the endpoints from the mapped rules in the Quart app
